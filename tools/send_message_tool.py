...
"description": (
                    ...
                    "this is the literal text the recipient will see. To send an image or file, include "
                    "MEDIA:<local_path> (e.g. 'MEDIA:/tmp/hermes/cache/img_xxx.jpg') — the platform will "
                    "deliver it as a native media attachment. "

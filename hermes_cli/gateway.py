...
_PLATFORMS = [
    ...
    },
    {
        ...
        "vars": [
            ...
            {"name": "AGENTPHONE_ALLOWED_PHONENUMBERS", "prompt": "Allowed phone numbers (comma-separated E.164)", "password": False,
             "is_allowlist": True,
             "help": "Outbound calls and inbound-from allowlist. Anyone not in this list cannot dial in and cannot be called by the agent."},
